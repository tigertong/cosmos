...
// [-9.7, 9.4],
$datarow1 .= "['".$row['Query_RawQuery']."',". $row['NUMBEROFQU']."],";
}
 }
...
$(function () {
    $('#container').highcharts({
        ...
        title: {
            text: 'request number per QUERY top 30'
        },
        subtitle: {
            text: ' '
        },
...
<div id="demo">
  <div id="demo_content">
    <div class="page-header">
      <h1>sougou IP QUERY distribution  <?php echo $submitdate; ?></h1>
      <div class="clear"></div>
    </div>
    <p> 图表主题：
...
<a href="sougou.php" > <button class="btn" theme="grid">sougou distribution</button></a>
	...
	<p>
	<form   action='QUList.php' method='get'>
...
$result = mysqli_query($db,"SELECT *  FROM QUinfo  WHERE date='$date'   ORDER BY NUMBEROFQU  desc limit 0,60 ");
while($row = mysqli_fetch_array($result,MYSQLI_ASSOC))
 {
 
  
  echo "  <tr>    <td>&nbsp;&nbsp;".$row['Query_RawQuery']."&nbsp;&nbsp;</td>    <td>&nbsp;&nbsp;".$row['NUMBEROFQU']."&nbsp;&nbsp;</td>  </tr>  ";
