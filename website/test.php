...
$SRPV_Raw   =$row4['SRPV_Raw'];
$SRPV_Anti_fraud  =$row4['SRPV_Anti_fraud'];
$Revenue =$row4['Revenue'];
$Impressions_Raw	 =$row4['Impressions_Raw'];
$Impressions_Anti_fraud  =$row4['Impressions_Anti_fraud'];
$Clicks_Raw	  =$row4['Clicks_Raw'];
$Clicks_Anti_fraud   =$row4['Clicks_Anti_fraud'];
$Coverage_Raw	 =$row4['Coverage_Raw'];
$Coverage_Anti_fraud  =$row4['Coverage_Anti_fraud'];
$CTR  =$row4['CTR'];
$ECPM  =$row4['ECPM'];
$CPC    =$row4['CPC'];
...
$import="INSERT Sogou_data (date,Revenue_7 ,Revenue_14 ,SRPV_7 ,SRPV_14 , Impressions_7 ,Impressions_14 ,Clicks_7 ,Clicks_14 ,ECPM_7 ,ECPM_14 ,Coverage_Raw_7 ,Coverage_Raw_14 ,CPC_7 ,CPC_14   ) values ( '$date',$Revenue_7 ,$Revenue_14 ,$SRPV_7 ,$SRPV_14 , $Impressions_7 ,$Impressions_14 ,$Clicks_7 ,$Clicks_14 ,$ECPM_7 ,$ECPM_14 ,$Coverage_Raw_7 ,$Coverage_Raw_14 ,$CPC_7 ,$CPC_14  ) ON DUPLICATE KEY UPDATE Revenue_7=$Revenue_7,Revenue_14=$Revenue_14,SRPV_7=$SRPV_7,SRPV_14=$SRPV_14,Impressions_7=$Impressions_7,Impressions_14=$Impressions_14,Clicks_7=$Clicks_7,Clicks_14=$Clicks_14,ECPM_7=$ECPM_7,ECPM_14=$ECPM_14,Coverage_Raw_7=$Coverage_Raw_7,Coverage_Raw_14=$Coverage_Raw_14,CPC_7=$CPC_7,CPC_14=$CPC_14  ";
echo $import;
...
<td width="41"><?php echo $db_CPC_14                     ;?>%</td>
        </tr>
      </table>
	</div>
    ...
    <div id="container" style="width: 900px; height: 400px;" data-highcharts-chart="0"><form   action='test.php' method='post'>
